...
export default class WorkOutList extends Component {
    ...
    constructor() {
        ...
        this.state = {
            FlatListItems: [
                {key: 'Warm-Up Workout', path:'wormupworkout'},
                {key: 'Basic Workout', path:'basicworkout'},
                {key: 'Weight Loss Workout',path:'weightlossWorkout'},
                {key: 'Weight Gain Workout',path:'weightlossWorkout'},
                {key: 'Bicep Workout',path:'bicepworkout'},
            ]};
    }
    state = {user: ''}
    updateUser = (user) => {
        ...
        return (
            <View style={styles.Container}>
                <View style={styles.Top}>
                    ...
                    <Text style={{color: '#008bc3', fontSize: 30}}> WorkOut </Text>
