...
export default class YogaList extends Component {
    ...
    constructor() {
        ...
        this.state = {
            FlatListItems: [
                {key: 'Simple Yoga',path:'yogadetails'},
                // {key: 'Power Yoga'},
                {key: 'Surya Namaskar',path:'Suryanamaskar'},
                {key: 'Weight Loss Yoga',path:'weightlossyoga'},
                {key: 'Before Pregnancy Yoga ',path:'prePregnancyyoga'},
                {key: 'After Pregnancy Yoga ',path:'postPregnancyyoga'},
            ]};
    }
    state = {user: ''}
    updateUser = (user) => {
        ...
        return (
            <View style={styles.Container}>
                <View style={styles.Top}>
                    ...
                    <Text style={{color: '#008bc3', fontSize: 30}}> Yoga </Text>
